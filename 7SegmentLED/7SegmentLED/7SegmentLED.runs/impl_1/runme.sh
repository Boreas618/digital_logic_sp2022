...
HD_PWD='C:/Users/Administrator/Desktop/7SegmentLED/7SegmentLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegLED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SevenSegLED.tcl -notrace
