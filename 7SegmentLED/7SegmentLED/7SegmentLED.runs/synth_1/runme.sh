...
HD_PWD='C:/Users/Administrator/Desktop/7SegmentLED/7SegmentLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegLED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SevenSegLED.tcl
