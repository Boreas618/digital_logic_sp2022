...
HD_PWD='C:/Users/33800/Desktop/digital_logic/rotating_block/rotating_block.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rotating_block_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rotating_block_top.tcl -notrace
