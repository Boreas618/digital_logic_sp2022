...
HD_PWD='C:/Users/33800/Desktop/digital_logic/rotating_block/rotating_block.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rotating_block_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rotating_block_top.tcl
