...
HD_PWD='C:/Users/33800/traffic_lights/traffic_lights.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_lights_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_lights_top.tcl -notrace
