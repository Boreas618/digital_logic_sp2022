...
HD_PWD='C:/Users/33800/traffic_lights/traffic_lights.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_lights_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_lights_top.tcl
